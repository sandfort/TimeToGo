...
public class ContactInfo extends Activity {
	...
	public void createContact(View view) {
		...
		Contact contact = ContactList.getContact(contactName.getText()
				.toString());
		if (contact != null) {
			int contactID = contact.getID();
			contact = new Contact(contactID, contactName.getText().toString(),
					contactNotes.getText().toString(), contactPhoneNumber
							.getText().toString(), contactEmail.getText()
							.toString());
		} else {
